...
var sliderEl = document.querySelectorAll(".sliderImg");
...
(function () {
    ...
    function loadImg() {
        fadeTo(currentImg, slideSpeed, 2);
    }

    function nextImgFade() {
        fadeTo(currentImg, slideSpeed, 0);
        fadeTo(nextImg, slideSpeed, 2);
    }

    function previousImgFade() {
        fadeTo(currentImg, slideSpeed, 0);
        fadeTo(previousImg, slideSpeed, 2);
    }

    function randomImgFade() {
        fadeTo(currentImg, slideSpeed, 0);
        fadeTo(randomImg, slideSpeed, 2);
    }
